public class TypeConversionDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Primitive int " + num + " autoboxed to Integer " + boxedNum
        );
        ...
        System.out.println(
            "Integer " + wrapObj + " unboxed to primitive int " + unboxed
        );
        ...
        System.out.println(
            "double " + val + " converted to String \"" + strVal + "\""
        );
        ...
        System.out.println(
            "String \"" + numStr + "\" converted to int " + parsedInt
        );
